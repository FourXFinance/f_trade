...
class Node:
    ...
    A Node is any independant link in the system. A node has collection of controllers
    These controllers have streams. Streams allow the sending and receiving of
    messages from other nodes in the system. It is best to subclass this module
    and implement your specific logic in that node.
    """
    enabled = False
    ...
    def __init__(self, system_name, name, test_mode = False):
        ...
        self.test_mode = test_mode #TODO: What does this mean?. What do we do in Test Mode
        self.system_name = system_name
        self.context = zmq.Context() # A Context is the ZMQ system.
    ...
    def setup_heartbeat(self, override_port=None):
        """
        Setup up the required port for the heartbeat.
        Node heatbeat ports are not related to node port... Yet
        """
        port = None
    ...
    def run(self):
        ...
        This almost always just starts the ioloop.
        """
        raise Exception("Override Me!")
    ...
    def shutdown(self, sig, frame):
        ...
        """
        #TODO: Disable and clean up
        print("Safe Shutdown Process")
        #TODO: Send Shutdown signal to logger
        #TODO: Dump Stats to .csv
...
class Algorithm(Node):
    """
    An algorithm is a special implementation of a Node
    Essentially, it has some deafualt values set for some stuff
    Do not use directly, rather subclass.
    """
    ...
    def load_config(self): # TODO: Consoladate this entire process into the Node Module
        """
        Load the config generated by the build process
        """
        try:
...
class Proxy(Node):
    """
    Proxies are interconnecting meshes needed when N:1 Communication is needed
    """
